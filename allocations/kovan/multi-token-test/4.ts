...
export default {
    initialValue: new BigNumber(10.63030726),
    tokens: [
        {
            name: "DAI",
            decimals: 18,
            ...
            value: new BigNumber(1.0146732673),
        },
        {
            name: "USDC",
            decimals: 6,
            ...
            weight: new BigNumber(0.2),
            value: new BigNumber(0.9976921690),
        },
        {
            name: "WBTC",
            decimals:  8,
            ...
            value: new BigNumber(6448.9214009421),
        },
        {
            name: "WETH",
            decimals: 18,
            ...
            weight: new BigNumber(0.3),
            value: new BigNumber(133.1121000622),
        }
    ]
}
